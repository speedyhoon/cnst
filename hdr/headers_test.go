...
func TestUnique(t *testing.T) {
	...
	names := map[string]string{
		...
		hdr.ActivateStorageAccess:               "activate-storage-access",
		hdr.Age:                                 "age",
		hdr.Allow:                               "allow",
		hdr.AltSvc:                              "alt-svc",
		...
		hdr.Cookie:                              "cookie",
		hdr.CrossOriginEmbedderPolicyReportOnly: "cross-origin-embedder-policy-report-only",
		...
		hdr.IntegrityPolicy:                     "integrity-policy",
		hdr.IntegrityPolicyReportOnly:           "integrity-policy-report-only",
		...
		hdr.SecFetchStorageAccess:               "sec-fetch-storage-access",
