...
Go integer constants for [polygons with specific quantities of edges](https://en.wikipedia.org/wiki/List_of_two-dimensional_geometric_shapes#Polygons_with_specific_numbers_of_sides).
